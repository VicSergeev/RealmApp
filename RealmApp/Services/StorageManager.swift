...
final class StorageManager {
    ...
    // MARK: - Tasks
    func saveTask(_ task: String, withNote note: String, to taskList: TaskList, completion: (Task) -> Void) {
        write {
    ...
    func editTask(_ task: Task, to newValue: String, withNote note: String) {
        write {
            task.title = newValue
            task.note = note
        }
